 ...
 * @author qipan
 */
public class SearchAVH extends JFrame {

    private String stuAcc;

    public SearchAVH(String stuAcc) {
        this.stuAcc = stuAcc;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
                ...
                if(stuAcc.equals(first.getStuid())) arrayList.add(first);
            }
    ...
    void print2(){
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
                ...
                if(stuAcc.equals(second.getStuid())) arrayList.add(second);
            }
    ...
    void print3(){
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
                ...
                if(stuAcc.equals(third.getStuid())) arrayList.add(third);
            }
    ...
    void print4(){
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
                ...
                if(stuAcc.equals(forth.getStuid())) arrayList.add(forth);
            }
    ...
    void print5(){
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
                ...
                if(stuAcc.equals(fifth.getStuid())) arrayList.add(fifth);
            }
    ...
    void print6(){
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
                ...
                if(stuAcc.equals(sixth.getStuid())) arrayList.add(sixth);
            }
