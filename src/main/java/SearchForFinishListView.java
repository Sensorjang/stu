 ...
 * @author qipan
 */
public class SearchForFinishListView extends JFrame {
    public SearchForFinishListView() {
        initComponents();
    }
    ...
    private void button1ActionPerformed(ActionEvent e) {//按钮
        // TODO add your code here
        ...
        try{
            ...
            if(comboBox1.getSelectedIndex()==0){
                file = "D:\\first.txt";
                FirstUploadTh firstUpload = new FirstUploadTh(file,row);
                firstUpload.setVisible(true);
            }else if(comboBox1.getSelectedIndex()==1){
                file = "D:\\second.txt";
                SecondUploadTh secondUpload = new SecondUploadTh(file,row);
                secondUpload.setVisible(true);
            }else if(comboBox1.getSelectedIndex()==2){
                file = "D:\\third.txt";
                ThirdUploadTh thirdUpload = new ThirdUploadTh(file,row);
                thirdUpload.setVisible(true);
            }else if(comboBox1.getSelectedIndex()==3){
                file = "D:\\fourth.txt";
                FourthUploadTh fourthUpload = new FourthUploadTh(file,row);
                fourthUpload.setVisible(true);
            }else if(comboBox1.getSelectedIndex()==4){
                file = "D:\\fifth.txt";
                FifthUploadTh fifthUpload = new FifthUploadTh(file,row);
                fifthUpload.setVisible(true);
            }else if(comboBox1.getSelectedIndex()==5){
                file = "D:\\sixth.txt";
                SixthUploadTh sixthUpload = new SixthUploadTh(file,row);
    ...
    private void initComponents() {
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
                ...
                first.setFinish(Integer.parseInt(jsonObject.getString("finish")));
                arrayList.add(first);
            }
        ...
        for(First one : arrayList) {
            ...
            v.add(one.getStuid());
            v.add(one.getType());
            if(one.getFinish() == 1)arrayList1.add(i);//完成补全的
            def.addRow(v);
        }
        System.out.println(arrayList1);
        setcolor(table1,arrayList1);
    }
    ...
    void print2(){
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
                ...
                second.setFinish(Integer.parseInt(jsonObject.getString("finish")));
    ...
    void print3(){
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
                ...
                third.setFinish(Integer.parseInt(jsonObject.getString("finish")));
                arrayList.add(third);
            }
    ...
    void print4(){
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
                ...
                forth.setFinish(Integer.parseInt(jsonObject.getString("finish")));
                arrayList.add(forth);
            }
    ...
    private void setcolor (JTable table,ArrayList<Integer> finish){
        try {
            DefaultTableCellRenderer tcr = new DefaultTableCellRenderer() {
                public Component getTableCellRendererComponent(JTable table,
                                                               Object value, boolean isSelected, boolean hasFocus,
                                                               int row, int column) {
                    if(finish.contains(row+1))
